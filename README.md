...
local Window = Library.CreateLib("DMAG", "DarkTheme") 

-- PLAYER 
local Player = Window:NewTab("Player") 
local PlayerSection = Player:NewSection("ClientSide") 

PlayerSection:NewButton("Fly", "You can fly you idiot", function()
    local Speed = 150
...
PlayerSection:NewToggle("NoClip", "Q To Toggle Also It's not a button to lazy to fix it", function(state)
    if state then
...
PlayerSection:NewButton("ESP", "Bad ESP 2/5 Still works", function()
    print("Clicked")
end) 
...
CombatSection:NewButton("AimLock", "AimLock", function()
